...
export class ACCOUNT implements StructClass { __StructClass = true as const;
 ...
 static reified( ): ACCOUNTReified { const reifiedBcs = ACCOUNT.bcs; return { typeName: ACCOUNT.$typeName, fullTypeName: composeSuiType( ACCOUNT.$typeName, ...[] ) as `${typeof PKG_V1}::account::ACCOUNT`, typeArgs: [ ] as [], isPhantom: ACCOUNT.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ACCOUNT.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ACCOUNT.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ACCOUNT.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => ACCOUNT.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ACCOUNT.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ACCOUNT.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => ACCOUNT.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => ACCOUNT.fetch( client, id, ), new: ( fields: ACCOUNTFields, ) => { return new ACCOUNT( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("ACCOUNT", {

 dummy_field: bcs.bool()

}) };

 private static cachedBcs: ReturnType<typeof ACCOUNT.instantiateBcs> | null = null;

 static get bcs() { if (!ACCOUNT.cachedBcs) { ACCOUNT.cachedBcs = ACCOUNT.instantiateBcs() } return ACCOUNT.cachedBcs };
...
export interface AccountFields { id: ToField<UID>; alias: ToField<Option<String>> }
...
export class Account implements StructClass { __StructClass = true as const;
 ...
 readonly id: ToField<UID>; readonly alias: ToField<Option<String>>
 ...
 id: UID.bcs, alias: Option.bcs(String.bcs)
 ...
 static fromFields( fields: Record<string, any> ): Account { return Account.reified( ).new( { id: decodeFromFields(UID.reified(), fields.id), alias: decodeFromFields(Option.reified(String.reified()), fields.alias) } ) }

 static fromFieldsWithTypes( item: FieldsWithTypes ): Account { if (!isAccount(item.type)) { throw new Error("not a Account type");

 }

 return Account.reified( ).new( { id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), alias: decodeFromFieldsWithTypes(Option.reified(String.reified()), item.fields.alias) } ) }

 static fromBcs( data: Uint8Array ): Account { return Account.fromFields( Account.bcs.parse(data) ) }

 toJSONField() { return {

 id: this.id,alias: fieldToJSON<Option<String>>(`${Option.$typeName}<${String.$typeName}>`, this.alias),

} }

 toJSON() { return { $typeName: this.$typeName, $typeArgs: this.$typeArgs, ...this.toJSONField() } }

 static fromJSONField( field: any ): Account { return Account.reified( ).new( { id: decodeFromJSONField(UID.reified(), field.id), alias: decodeFromJSONField(Option.reified(String.reified()), field.alias) } ) }
...
export class AccountRequest implements StructClass { __StructClass = true as const;
 ...
 static reified( ): AccountRequestReified { const reifiedBcs = AccountRequest.bcs; return { typeName: AccountRequest.$typeName, fullTypeName: composeSuiType( AccountRequest.$typeName, ...[] ) as `${typeof PKG_V1}::account::AccountRequest`, typeArgs: [ ] as [], isPhantom: AccountRequest.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => AccountRequest.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => AccountRequest.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => AccountRequest.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => AccountRequest.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => AccountRequest.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => AccountRequest.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => AccountRequest.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => AccountRequest.fetch( client, id, ), new: ( fields: AccountRequestFields, ) => { return new AccountRequest( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("AccountRequest", {

 account: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), })

}) };

 private static cachedBcs: ReturnType<typeof AccountRequest.instantiateBcs> | null = null;

 static get bcs() { if (!AccountRequest.cachedBcs) { AccountRequest.cachedBcs = AccountRequest.instantiateBcs() } return AccountRequest.cachedBcs };
