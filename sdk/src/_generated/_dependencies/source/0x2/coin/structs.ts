...
export class Coin<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Coin.cachedBcs) { Coin.cachedBcs = Coin.instantiateBcs() } return Coin.cachedBcs };
...
export class CoinMetadata<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!CoinMetadata.cachedBcs) { CoinMetadata.cachedBcs = CoinMetadata.instantiateBcs() } return CoinMetadata.cachedBcs };
...
export class RegulatedCoinMetadata<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!RegulatedCoinMetadata.cachedBcs) { RegulatedCoinMetadata.cachedBcs = RegulatedCoinMetadata.instantiateBcs() } return RegulatedCoinMetadata.cachedBcs };
...
export class TreasuryCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!TreasuryCap.cachedBcs) { TreasuryCap.cachedBcs = TreasuryCap.instantiateBcs() } return TreasuryCap.cachedBcs };
...
export class DenyCapV2<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!DenyCapV2.cachedBcs) { DenyCapV2.cachedBcs = DenyCapV2.instantiateBcs() } return DenyCapV2.cachedBcs };
...
export class CurrencyCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!CurrencyCreated.cachedBcs) { CurrencyCreated.cachedBcs = CurrencyCreated.instantiateBcs() } return CurrencyCreated.cachedBcs };
...
export class DenyCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!DenyCap.cachedBcs) { DenyCap.cachedBcs = DenyCap.instantiateBcs() } return DenyCap.cachedBcs };
