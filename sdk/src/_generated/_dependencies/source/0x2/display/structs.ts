...
export class Display<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Display.cachedBcs) { Display.cachedBcs = Display.instantiateBcs() } return Display.cachedBcs };
...
export class DisplayCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!DisplayCreated.cachedBcs) { DisplayCreated.cachedBcs = DisplayCreated.instantiateBcs() } return DisplayCreated.cachedBcs };
...
export class VersionUpdated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!VersionUpdated.cachedBcs) { VersionUpdated.cachedBcs = VersionUpdated.instantiateBcs() } return VersionUpdated.cachedBcs };
