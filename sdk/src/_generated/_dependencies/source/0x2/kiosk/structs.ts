...
export class Kiosk implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Kiosk.cachedBcs) { Kiosk.cachedBcs = Kiosk.instantiateBcs() } return Kiosk.cachedBcs };
...
export class KioskOwnerCap implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!KioskOwnerCap.cachedBcs) { KioskOwnerCap.cachedBcs = KioskOwnerCap.instantiateBcs() } return KioskOwnerCap.cachedBcs };
...
export class PurchaseCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!PurchaseCap.cachedBcs) { PurchaseCap.cachedBcs = PurchaseCap.instantiateBcs() } return PurchaseCap.cachedBcs };
...
export class Borrow implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Borrow.cachedBcs) { Borrow.cachedBcs = Borrow.instantiateBcs() } return Borrow.cachedBcs };
...
export class Item implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Item.cachedBcs) { Item.cachedBcs = Item.instantiateBcs() } return Item.cachedBcs };
...
export class Listing implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Listing.cachedBcs) { Listing.cachedBcs = Listing.instantiateBcs() } return Listing.cachedBcs };
...
export class Lock implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Lock.cachedBcs) { Lock.cachedBcs = Lock.instantiateBcs() } return Lock.cachedBcs };
...
export class ItemListed<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!ItemListed.cachedBcs) { ItemListed.cachedBcs = ItemListed.instantiateBcs() } return ItemListed.cachedBcs };
...
export class ItemPurchased<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!ItemPurchased.cachedBcs) { ItemPurchased.cachedBcs = ItemPurchased.instantiateBcs() } return ItemPurchased.cachedBcs };
...
export class ItemDelisted<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!ItemDelisted.cachedBcs) { ItemDelisted.cachedBcs = ItemDelisted.instantiateBcs() } return ItemDelisted.cachedBcs };
