...
export class ID implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!ID.cachedBcs) { ID.cachedBcs = ID.instantiateBcs() } return ID.cachedBcs };
...
export class UID implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!UID.cachedBcs) { UID.cachedBcs = UID.instantiateBcs() } return UID.cachedBcs };
