...
export class Scalar implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Scalar.cachedBcs) { Scalar.cachedBcs = Scalar.instantiateBcs() } return Scalar.cachedBcs };
...
export class G1 implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!G1.cachedBcs) { G1.cachedBcs = G1.instantiateBcs() } return G1.cachedBcs };
...
export class G2 implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!G2.cachedBcs) { G2.cachedBcs = G2.instantiateBcs() } return G2.cachedBcs };
...
export class GT implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!GT.cachedBcs) { GT.cachedBcs = GT.instantiateBcs() } return GT.cachedBcs };
...
export class UncompressedG1 implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!UncompressedG1.cachedBcs) { UncompressedG1.cachedBcs = UncompressedG1.instantiateBcs() } return UncompressedG1.cachedBcs };
