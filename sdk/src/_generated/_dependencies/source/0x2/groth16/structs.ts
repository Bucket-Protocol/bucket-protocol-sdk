...
export class Curve implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Curve.cachedBcs) { Curve.cachedBcs = Curve.instantiateBcs() } return Curve.cachedBcs };
...
export class PreparedVerifyingKey implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!PreparedVerifyingKey.cachedBcs) { PreparedVerifyingKey.cachedBcs = PreparedVerifyingKey.instantiateBcs() } return PreparedVerifyingKey.cachedBcs };
...
export class PublicProofInputs implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!PublicProofInputs.cachedBcs) { PublicProofInputs.cachedBcs = PublicProofInputs.instantiateBcs() } return PublicProofInputs.cachedBcs };
...
export class ProofPoints implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!ProofPoints.cachedBcs) { ProofPoints.cachedBcs = ProofPoints.instantiateBcs() } return ProofPoints.cachedBcs };
