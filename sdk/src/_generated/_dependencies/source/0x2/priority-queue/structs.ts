...
export class PriorityQueue<T extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!PriorityQueue.cachedBcs) { PriorityQueue.cachedBcs = PriorityQueue.instantiateBcs() } return PriorityQueue.cachedBcs };
...
export class Entry<T extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Entry.cachedBcs) { Entry.cachedBcs = Entry.instantiateBcs() } return Entry.cachedBcs };
