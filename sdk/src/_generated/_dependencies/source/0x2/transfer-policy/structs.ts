...
export class TransferRequest<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!TransferRequest.cachedBcs) { TransferRequest.cachedBcs = TransferRequest.instantiateBcs() } return TransferRequest.cachedBcs };
...
export class TransferPolicy<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!TransferPolicy.cachedBcs) { TransferPolicy.cachedBcs = TransferPolicy.instantiateBcs() } return TransferPolicy.cachedBcs };
...
export class TransferPolicyCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!TransferPolicyCap.cachedBcs) { TransferPolicyCap.cachedBcs = TransferPolicyCap.instantiateBcs() } return TransferPolicyCap.cachedBcs };
...
export class TransferPolicyCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!TransferPolicyCreated.cachedBcs) { TransferPolicyCreated.cachedBcs = TransferPolicyCreated.instantiateBcs() } return TransferPolicyCreated.cachedBcs };
...
export class TransferPolicyDestroyed<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!TransferPolicyDestroyed.cachedBcs) { TransferPolicyDestroyed.cachedBcs = TransferPolicyDestroyed.instantiateBcs() } return TransferPolicyDestroyed.cachedBcs };
...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!RuleKey.cachedBcs) { RuleKey.cachedBcs = RuleKey.instantiateBcs() } return RuleKey.cachedBcs };
