...
export class Extension implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Extension.cachedBcs) { Extension.cachedBcs = Extension.instantiateBcs() } return Extension.cachedBcs };
...
export class ExtensionKey<Ext extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!ExtensionKey.cachedBcs) { ExtensionKey.cachedBcs = ExtensionKey.instantiateBcs() } return ExtensionKey.cachedBcs };
