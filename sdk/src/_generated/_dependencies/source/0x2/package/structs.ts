...
export class Publisher implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Publisher.cachedBcs) { Publisher.cachedBcs = Publisher.instantiateBcs() } return Publisher.cachedBcs };
...
export class UpgradeCap implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!UpgradeCap.cachedBcs) { UpgradeCap.cachedBcs = UpgradeCap.instantiateBcs() } return UpgradeCap.cachedBcs };
...
export class UpgradeTicket implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!UpgradeTicket.cachedBcs) { UpgradeTicket.cachedBcs = UpgradeTicket.instantiateBcs() } return UpgradeTicket.cachedBcs };
...
export class UpgradeReceipt implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!UpgradeReceipt.cachedBcs) { UpgradeReceipt.cachedBcs = UpgradeReceipt.instantiateBcs() } return UpgradeReceipt.cachedBcs };
