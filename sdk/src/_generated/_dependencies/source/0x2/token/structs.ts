...
export class Token<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Token.cachedBcs) { Token.cachedBcs = Token.instantiateBcs() } return Token.cachedBcs };
...
export class TokenPolicyCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!TokenPolicyCap.cachedBcs) { TokenPolicyCap.cachedBcs = TokenPolicyCap.instantiateBcs() } return TokenPolicyCap.cachedBcs };
...
export class TokenPolicy<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!TokenPolicy.cachedBcs) { TokenPolicy.cachedBcs = TokenPolicy.instantiateBcs() } return TokenPolicy.cachedBcs };
...
export class ActionRequest<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!ActionRequest.cachedBcs) { ActionRequest.cachedBcs = ActionRequest.instantiateBcs() } return ActionRequest.cachedBcs };
...
export class TokenPolicyCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!TokenPolicyCreated.cachedBcs) { TokenPolicyCreated.cachedBcs = TokenPolicyCreated.instantiateBcs() } return TokenPolicyCreated.cachedBcs };
