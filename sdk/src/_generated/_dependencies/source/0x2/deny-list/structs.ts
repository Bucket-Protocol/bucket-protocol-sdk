...
export class DenyList implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!DenyList.cachedBcs) { DenyList.cachedBcs = DenyList.instantiateBcs() } return DenyList.cachedBcs };
...
export class ConfigWriteCap implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!ConfigWriteCap.cachedBcs) { ConfigWriteCap.cachedBcs = ConfigWriteCap.instantiateBcs() } return ConfigWriteCap.cachedBcs };
...
export class ConfigKey implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!ConfigKey.cachedBcs) { ConfigKey.cachedBcs = ConfigKey.instantiateBcs() } return ConfigKey.cachedBcs };
...
export class AddressKey implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!AddressKey.cachedBcs) { AddressKey.cachedBcs = AddressKey.instantiateBcs() } return AddressKey.cachedBcs };
...
export class GlobalPauseKey implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!GlobalPauseKey.cachedBcs) { GlobalPauseKey.cachedBcs = GlobalPauseKey.instantiateBcs() } return GlobalPauseKey.cachedBcs };
...
export class PerTypeConfigCreated implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!PerTypeConfigCreated.cachedBcs) { PerTypeConfigCreated.cachedBcs = PerTypeConfigCreated.instantiateBcs() } return PerTypeConfigCreated.cachedBcs };
...
export class PerTypeList implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!PerTypeList.cachedBcs) { PerTypeList.cachedBcs = PerTypeList.instantiateBcs() } return PerTypeList.cachedBcs };
