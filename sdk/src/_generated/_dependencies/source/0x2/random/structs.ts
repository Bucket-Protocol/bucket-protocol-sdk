...
export class Random implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Random.cachedBcs) { Random.cachedBcs = Random.instantiateBcs() } return Random.cachedBcs };
...
export class RandomInner implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!RandomInner.cachedBcs) { RandomInner.cachedBcs = RandomInner.instantiateBcs() } return RandomInner.cachedBcs };
...
export class RandomGenerator implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!RandomGenerator.cachedBcs) { RandomGenerator.cachedBcs = RandomGenerator.instantiateBcs() } return RandomGenerator.cachedBcs };
