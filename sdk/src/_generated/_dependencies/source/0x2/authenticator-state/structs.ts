...
export class AuthenticatorState implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!AuthenticatorState.cachedBcs) { AuthenticatorState.cachedBcs = AuthenticatorState.instantiateBcs() } return AuthenticatorState.cachedBcs };
...
export class AuthenticatorStateInner implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!AuthenticatorStateInner.cachedBcs) { AuthenticatorStateInner.cachedBcs = AuthenticatorStateInner.instantiateBcs() } return AuthenticatorStateInner.cachedBcs };
...
export class JWK implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!JWK.cachedBcs) { JWK.cachedBcs = JWK.instantiateBcs() } return JWK.cachedBcs };
...
export class JwkId implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!JwkId.cachedBcs) { JwkId.cachedBcs = JwkId.instantiateBcs() } return JwkId.cachedBcs };
...
export class ActiveJwk implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!ActiveJwk.cachedBcs) { ActiveJwk.cachedBcs = ActiveJwk.instantiateBcs() } return ActiveJwk.cachedBcs };
