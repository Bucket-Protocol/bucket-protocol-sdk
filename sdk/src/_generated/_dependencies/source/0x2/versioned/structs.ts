...
export class Versioned implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Versioned.cachedBcs) { Versioned.cachedBcs = Versioned.instantiateBcs() } return Versioned.cachedBcs };
...
export class VersionChangeCap implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!VersionChangeCap.cachedBcs) { VersionChangeCap.cachedBcs = VersionChangeCap.instantiateBcs() } return VersionChangeCap.cachedBcs };
