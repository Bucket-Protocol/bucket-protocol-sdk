...
export class String implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!String.cachedBcs) { String.cachedBcs = String.instantiateBcs() } return String.cachedBcs };
...
export class Char implements StructClass { __StructClass = true as const;
 ...
 static get bcs() { if (!Char.cachedBcs) { Char.cachedBcs = Char.instantiateBcs() } return Char.cachedBcs };
