...
import { bcs, BcsEnum, BcsStruct, BcsTuple, TypeTag, TypeTagSerializer } from '@mysten/sui/bcs';
...
export class MoveStruct<T extends Record<string, BcsType<any>>, const Name extends string = string> extends BcsStruct<
  T,
  Name
> {}

export class MoveEnum<T extends Record<string, BcsType<any, string> | null>, const Name extends string> extends BcsEnum<
  T,
  Name
> {}

export class MoveTuple<T extends readonly BcsType<any, string>[], const Name extends string> extends BcsTuple<
  T,
  Name
> {}
