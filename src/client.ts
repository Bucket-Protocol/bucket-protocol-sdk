...
export class BucketClient {
  ...
  updateSupraOracle(tx: Transaction, token: string) {
    ...
    if (token === "afSUI" || token === "AF_LP_SUI_SUI") {
      ...
      tx.moveCall({
        target:
          "0x7e64dcbb4aa2f2af0e3d13c6baeb2baf4fc375fa765cadd9483087ae70e4503d::scoin_rule::update_price",
  ...
  psmSwapOut(
    ...
    if (outCoinType === COINS_TYPE_LIST.STAPEARL) {
      ...
      return tx.moveCall({
        target:
          "0x1b4b5dd782453586f2a39dbc154f9ef4ca7780ae9a31154c1c6080985a5d295e::scable::withdraw_coin_from_spool",
        typeArguments: [outCoinType],
        arguments: [
