...
class BucketClient {
    ...
    psmSwapIn(tx, coinType, coinInput, referrer) {
         ...
         * @returns Coin<BUCK>
         */
        const balanceInput = (0, utils_2.coinIntoBalance)(tx, coinType, coinInput);
        ...
        const coinOut = (0, utils_2.coinFromBalance)(tx, constants_1.COINS_TYPE_LIST.BUCK, balanceOut);
