...
export declare function coinIntoBalance(tx: TransactionBlock, coinType: string, coinInput: TransactionArgument | undefined): import("@mysten/sui.js/transactions").TransactionResult;
