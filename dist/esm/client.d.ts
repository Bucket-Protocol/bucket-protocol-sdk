...
export declare class BucketClient {
    ...
    borrow(tx: TransactionBlock, collateralType: string, collateralInput: TransactionResult, buckOutput: TransactionArgument, insertionPlace?: string, strapId?: string | TransactionArgument): TransactionResult;
